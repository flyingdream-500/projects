...
object ListeningNotification {
    ...
    fun ContextWrapper.createPlayNotification(trackName: String): Notification {
        val remoteViews =
            RemoteViews(packageName, R.layout.listening_notification_play_layout)
        ...
        //Exit click
        val exit = Intent(this, ListeningService::class.java).also {
    ...
    fun ContextWrapper.createPauseNotification(trackName: String): Notification {
        val remoteViews =
            RemoteViews(packageName, R.layout.listening_notification_pause_layout)
    ...
    fun ContextWrapper.startNotification(trackName: String) {
        ...
        getNotificationManager().notify(LISTENING_NOTIFICATION_ID, notification)
    }
