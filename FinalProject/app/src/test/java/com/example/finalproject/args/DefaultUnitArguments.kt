...
/**
 * Дефолтное значение данных о курсах валют, полученных с API
 */
val CURRENT_CURRENCY = CurrentCurrency(
    "2021-11-26",
    Rates(
        0.862298f,
        1.238965f,
 ...
 */
val CURRENT_TRANSACTION = CurrencyTransaction(
    id = 1,
    baseSum = "1000",
    targetSum = "2000",
 ...
 */
val DEFAULT_BANK_CARD = BankCard(
    id = 1,
    balance = 1_000.00,
 ...
 */
val CURRENT_CURRENCY_ITEM = CurrentCurrencyItem(
    date = "2021-11-26",
    listOf(
...
/**
 * Дефолтное значение JSON курса валют
 */
const val JSON_CURRENT_CURRENCY =
    "{\"date\":\"2021-11-26\",\"usd\":{\"eur\":0.862298,\"cad\":1.238965,\"cny\":6.38302,\"sgd\":1.347226,\"gbp\":0.726351,\"dkk\":6.414402,\"nok\":8.364304,\"sek\":8.613434,\"chf\":0.91976,\"jpy\":114.18154,\"rub\":69.47352}}"